                        ...
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                ...
                                <div id="submenu-1" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="/admin/dashboards-analytics" data-toggle="collapse" aria-expanded="false" data-target="#submenu-1-2" aria-controls="submenu-1-2">E-Commerce</a>
                                            <div id="submenu-1-2" class="collapse submenu" style="">
                                                <ul class="nav flex-column">
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="/admin/dashboards-analytics">E Commerce Dashboard</a>
                                                    </li>
                                                    <li class="nav-item">
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-5" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <!-- <li class="nav-item">
                                            <a class="nav-link" href="/admin/general-tables">General Tables</a>
                                        </li> -->
                                        <li class="nav-item">
                                            <a class="nav-link" href="/admin/config-tables">Config Tables</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="/admin/product-tables">Product Tables</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
